# -*- coding: utf-8 -*-
"""
Created on Thu May 26 15:56:06 2022
"""
...
#equation from a set of equations using Gauss elimination mmethod. 
#==============================================================================
...
#This function will be used to determine the unknowns of the curve fitting 
#equation from a set of equations using Gauss Jordan mmethod. 
#==============================================================================
def Gauss_Jordan(a):
...
#This function will be used to determine the unknowns of the curve fitting 
#equation from a set of equations using LU decomposition mmethod. 
#==============================================================================
...
#This function will be used to determine the unknowns of the curve fitting 
#equation from a set of equations using Gauss Seidel mmethod. 
#==============================================================================
def Gauss_Seidel(a):
    ...
    return X, p
#==============================================================================
# Declaration of different functions are finished here. The main code for 
#polynomial regression begins after this comment. 
#==============================================================================
#taking necessary input values from keyboard
m=int(input('Enter the order of the regression polynomial: ' ))

#Reading data from excel file
loc = (r'H:/Education/3-1 3rd Year Odd Semester - ETE 18/Numerical Method/Lab/Lab 5/data_Polynomial Regression.xlsx')
